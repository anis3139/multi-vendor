...
if (facebook.length == 0) {
    ...
    axios.post("{{ route('admin.facebook') }}", {
        facebook: facebook
    })
...
if (twitter.length == 0) {
    ...
    $('#submitTwitter').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("{{ route('admin.twitter') }}", {
        twitter: twitter
    })
        .then(function (response) {
...
if (youtube.length == 0) {
    ...
    $('#submitYoutube').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("{{ route('admin.youtube') }}", {
        youtube: youtube
    })
        .then(function (response) {
...
if (instragram.length == 0) {
    ...
    $('#submitInstagram').html(
        "<div class='spinner-border spinner-border-sm text-primary' role='status'></div>"); //animation
    axios.post("{{ route('admin.instragram') }}", {
