                            ...
                            <div class="row">
                                @foreach ($allProducts as $allProduct)
                                    <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-4">
                                        <div class="item">
                                            <div class="pad15">
                                                <a href="{{ route('product-view', ['slug'=>$allProduct->product_slug]) }}" class="text-dark text-decoration-none">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <h5 class="card-title">{{$allProduct->product_title}}</h5>
                                                            <p class="card-subtitle mb-2 text-muted">{{$allProduct->brand->name}}</p>
                                                            <div
                                                                class="buy d-flex justify-content-between align-items-center border-top">
                                                                <div class="price text-success">
                                                                    <h5 class="mt-4">&#2547;&nbsp;{{$allProduct->product_price}}</h5>
                                                                </div> &emsp;
                                                                <a href="{{ route('product-view', ['slug'=>$allProduct->product_slug]) }}"
